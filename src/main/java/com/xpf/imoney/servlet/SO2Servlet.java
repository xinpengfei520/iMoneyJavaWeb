...
@WebServlet(name = "SO2Servlet", urlPatterns = "/so2")
public class SO2Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String path = getServletContext().getRealPath("/") + VerifyUtils.getPathByToken(token, "json/so2.json");
